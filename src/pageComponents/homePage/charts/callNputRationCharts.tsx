...
export function CallNputRationCharts({ data } : { data: Array<{ last_fetched_date: string; ratio: any }> }) {

    // Transform data to fit chartData structure
    const chartData = data.map((item: { last_fetched_date: string; ratio: any }) => {
